...
#define CABELL_BIND_RADIO_ADDR  0xA4B7C123F7UL

#define CABELL_NUM_CHANNELS     16                  // The maximum number of RC channels that can be sent in one packet
#define CABELL_NUM_PPM_CHANNELS  8                  // The maximum number of RC channels in PPM mode
...
extern volatile uint8_t channelsRecieved;
